...
<head>
<meta charset="utf-8">
<title>	Booking Summary :: APATOUR.com</title>
  ...
  <div class="navbar yamm navbar-default" id="sticky">
    <div class="container">
      <div class="navbar-header">
        ...
        <!-- Logo -->
        <div id="logo"> <img id="default-logo" src="<?php echo URL."asset/";?>images/logo.png"  style="height:44px;"> <img id="retina-logo" src="<?php echo URL."asset/";?>images/logo-retina.png"  style="height:44px;"> APATour.com</div>
        </a> </div>
