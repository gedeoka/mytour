...
-->
			...
			<br>
			<input name="Tour" type="hidden" class="form-control" value="<?php echo $this->single[0]["TourName"]." | ".$this->single[0]["TourCode"]." | ".$this->single[0]["TourID"];?>" />
			<div class="col-md-12">
        ...
        <div class="row">
          <div class="col-sm-12 mt50">
			...
			<li class="active"><a href="#overview" data-toggle="tab"> Detail</a></li>			
              <li><a href="#iten" data-toggle="tab">Tour Schedule</a></li>         
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane fade" id="iten">
                <?php echo  str_replace("%27","'",$this->single[0]["Itenery"]);?>
              </div>
