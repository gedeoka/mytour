    ...
    <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title">Choose Package
			          <br><small><a href="<?php echo URL."admin/setcountry/";?>" class="btn btn-success btn-xs">Back</a></small></h3>
            </div>
            <div class="box-body">
              <!-- Minimal style -->
			<div class="row col-sm-12">
                        ...
                        ?>
                            ...
                            <div class="imgList col-sm-3">
								<h3><?php echo $value['CountryName']; ?></h3>
								<div class="desk"><?php echo substr($value['Desk'],0,100); ?>								
								<a class="del btn btn-success" href="#" rel="<?php echo $value['CountryID']; ?>" rels="<?php echo $value['CountryID']; ?>"> Add To FrontPage </a>
								</div>
							</div>
                        <?php } ?>
...
$('.del').click(function(){
    ...
    $.post("<?php echo URL.'admin/';?>savesetcountry",{gid:gid,prid:prid},function(x){
       //alert(x);
       delItem.remove();
    });
    return false;
