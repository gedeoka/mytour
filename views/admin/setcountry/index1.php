...
<div class="clearfix"></div>
    <div class="box box-success">
            <div class="box-header">
			  ...
			  <small> <a class="btn btn-success btn-xs" href="<?php echo URL;?>admin/addsetcountry/">Add New</a>  </small>
            </div>
            <div class="box-body">
              <!-- Minimal style -->
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
				  ...
				  <td><a class="del btn btn-danger" href="#" rel="<?php echo $value['CountryID']; ?>" rels="<?php echo $value['CountryID']; ?>"> Remove </a></td>
                </tr>
                <?php } ?>
                </tbody>
...
$('.del').click(function(){
    ...
    $.post("<?php echo URL.'admin/';?>delsetcountry",{gid:gid,prid:prid},function(x){
        //alert(x);
       //delItem.remove();
