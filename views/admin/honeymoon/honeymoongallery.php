...
$('.del').click(function(){
    ...
    $.post("<?php echo URL.'admin/hm';?>delgal",{gid:gid,prid:prid},function(x){
        //alert(x);
       delItem.remove();
    });
    return false;
...
//alert("def");
    ...
    $.post("<?php echo URL.'admin/hmdefg';?>",{gid:gid,prid:prid},function(x){
       location.reload();
    });
    //return false;
...
$('.unset').click(function(){
    ...
    $.post("<?php echo URL.'admin/hmunsetg';?>",{gid:gid,prid:prid},function(x){
       location.reload();
    });
    // false;
