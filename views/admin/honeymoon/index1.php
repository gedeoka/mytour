        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
			  ...
			  <small> <a class="btn btn-success btn-xs" href="<?php echo URL;?>admin/addhm/">Add New</a>  </small>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
				  ...
				  <td><?php echo "Couple : ".$value['Cur']." ".number_format($value['Price1']); ?></td>
				  <td><a  class="btn btn-success btn-xs" href="<?php echo URL."admin/hmsetgallery/".$value['TourID']; ?>"> Set<br>Gallery</a></td>
                  <td><a class="btn btn-warning btn-xs" href="<?php echo URL."admin/edithm/".$value['TourID']; ?>">Edit</a></td>
                  <td>
				  <div id="stat">
  ...
  $('.del').click(function(){
   ...
   //var gnm = $(this).attr('rels');
	...
	if (confirm('Are you sure you want to Void This Tour ?')) {
		$.post("<?php echo URL.'admin/voidhm';?>/",{gid:gid},function(x){
			$(this).remove();
...
$('.act').click(function(){
   ...
   //var gnm = $(this).attr('rels');
	...
	if (confirm('Are you sure you want to Activate This Tour ?')) {
		$.post("<?php echo URL.'admin/acthm';?>",{gid:gid},function(x){
			$(this).remove();
