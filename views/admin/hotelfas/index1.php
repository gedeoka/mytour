        ...
        <div class="col-xs-12">
          ...
          <div class="box  col-xs-6">
            <div class="box-header with-border">
              <h3 class="box-title">Add New Hotel Fasility</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo URL."admin/addhotelfas";?>" method="GET">
              <div class="box-body  col-xs-6">
                <div class="form-group">
                  <label for="exampleInputEmail1">Hotel Fasility Name :</label>
                  <input name="name" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Hotel Fasility Name">
                </div>
		...
		<div class="clearfix"></div>
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Hotel Fasility List  </h3><br>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th>Hotel FasilityID</th>
                  <th>Hotel Fasility Name</th>
                  <th></th>
                ...
                <tbody>
				<?php
                        foreach ($this->listhotelfas as $key => $value) {
                            ?>
                <tr>
                  <td><?php echo $value['hotelfasID']; ?></td>
                  <td><?php echo $value['hotelfasName']; ?></td>
                  <td><a href="<?php echo URL;?>admin/hotelfasedit/<?php echo $value['hotelfasID']; ?>"> Edit </a></td>
                </tr>
                <?php } ?>
                </tbody>
                <tfoot>
