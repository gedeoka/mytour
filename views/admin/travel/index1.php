        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
			  ...
			  <small> <a class="btn btn-success btn-xs" href="<?php echo URL;?>admin/addtr/">Add New</a>  </small>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
				  ...
				  <td><?php echo "Adult : ".$value['Cur']." ".number_format($value['Price1']); ?><br><?php echo "Child : ".$value['Cur']." ".number_format($value['Price2']); ?></td>
