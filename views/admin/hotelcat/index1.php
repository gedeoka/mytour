...
?>
        ...
        <div class="col-xs-12">
          ...
          <div class="box  col-xs-6">
            <div class="box-header with-border">
              <h3 class="box-title">Add New Property Type</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo URL."admin/addhotelcat";?>" method="GET">
              <div class="box-body  col-xs-6">
                <div class="form-group">
                  <label for="exampleInputEmail1">Property Type Name :</label>
                  <input name="name" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Property Type Name">
                </div>
		...
		<div class="clearfix"></div>
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Property Type List  </h3><br>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
				<?php
                        foreach ($this->listhotelcat as $key => $value) {
                            ?>
                <tr>
                  <td><?php echo $value['CategoryID']; ?></td>
                  <td><?php echo $value['CategoryName']; ?></td>
                  <td><a href="<?php echo URL;?>admin/hotelcatedit/<?php echo $value['CategoryID']; ?>"> Edit </a></td>
                </tr>
                <?php } ?>
                </tbody>
                <tfoot>
 ...
 <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 APATOUR.COM.</strong> All rights
    reserved.
  </footer>
