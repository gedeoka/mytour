      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box  col-xs-6">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo URL."admin/updhotelcat/".$this->hotelcatSingle['CategoryID'];?>" method="GET">
              <div class="box-body  col-xs-6">
                <div class="form-group">
                  <label for="exampleInputEmail1">Property Type Name :</label>
                  <input name="name" type="text" class="form-control" id="exampleInputEmail1" value="<?php echo $this->hotelcatSingle['CategoryName']; ?>">
                </div>
