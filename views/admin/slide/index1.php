              ...
              <!-- Minimal style -->
					<div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <input class="form-control" id="title" name="title" placeholder="Default Input" type="text" required>
                        </div>
                    </div>
					<div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Description</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <input class="form-control" id="desk" name="desk" placeholder="Default Input" type="text" required>
                        </div>
                    </div>
					<div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Url</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <input class="form-control" id="uri" name="uri" placeholder="Default Input" type="text" required>
                        </div>
                    </div>
                    <div class="form-group">
			...
			<div class="row">
                        ...
                        ?>
                            ...
                            <div class="imgList">
									...
									<p><?php echo $value['desk']; ?></p>
									<p><?php echo $value['uri']; ?></p>
                                    <a class="del btn btn-success" href="#" rel="<?php echo $value['SlideID']; ?>" rels="<?php echo $value['SlideID']; ?>"> Delete </a>
                            </div>
...
$('.del').click(function(){
    ...
    $.post("<?php echo URL.'admin/';?>delslide",{gid:gid},function(x){
        //alert(x);
       delItem.remove();
    });
    return false;
