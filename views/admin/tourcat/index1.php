        ...
        <div class="col-xs-12">
          ...
          <div class="box  col-xs-6">
            <div class="box-header with-border">
              <h3 class="box-title">Add New Tour Category</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo URL."admin/addtourcat";?>" method="GET">
              <div class="box-body  col-xs-6">
                <div class="form-group">
                  <label for="exampleInputEmail1">Tour Category Name :</label>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><a href="<?php echo URL;?>admin/tourcatedit/<?php echo $value['ID']; ?>"> Edit </a></td>
                </tr>
                <?php } ?>
                </tbody>
