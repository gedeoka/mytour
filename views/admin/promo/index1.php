...
<div class="clearfix"></div>
    <div class="box box-success">
            <div class="box-header">
			  ...
			  <small> <a class="btn btn-success btn-xs" href="<?php echo URL;?>admin/addpromo/">Add New</a>  </small>
            </div>
            <div class="box-body">
              <!-- Minimal style -->
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
				  ...
				  <td><?php echo Code::minTour($value['TourID']);?></td>
...
$('.del').click(function(){
    ...
    $.post("<?php echo URL.'admin/';?>delpromo",{gid:gid,prid:prid},function(x){
        //alert(x);
       //delItem.remove();
