    ...
    <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title">Choose Package
			          <br><small><a href="<?php echo URL."admin/promo/";?>" class="btn btn-success btn-xs">Back</a></small></h3>
            </div>
            <div class="box-body">
              <!-- Minimal style -->
			<div class="row col-sm-12">
                        ...
                        ?>
                            ...
                            <div class="imgList">
									...
									<p><?php echo Code::minTour($value['TourID']);?></p></div>
...
$('.del').click(function(){
    ...
    $.post("<?php echo URL.'admin/';?>savepromo",{gid:gid,prid:prid},function(x){
       //alert(x);
       delItem.remove();
    });
    return false;
