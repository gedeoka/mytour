...
*/
	...
	<div class="box-body">
         <div class="row">
        <form role="form" action="<?php echo URL."admin/savewedding";?>" method="POST">
        ...
        <div class="box-body">
          <div class="row">
			...
			<div class="form-group">
                  ...
                  <input name="WeddingCode" type="text" class="form-control" placeholder="Enter Package Code" maxlength="200" required>
				  
                </div>
              <div class="form-group">
                  <label>Package Name</label>
                  <input name="WeddingName" type="text" class="form-control" placeholder="Enter Package Name" maxlength="50" required>
				  <input name="WeddingID" type="hidden" class="form-control" value="<?php echo Code::random_string();?>" required>
                </div>
              ...
              <div class="form-group">
                ...
                <select name="area" class="form-control " data-placeholder="Select a State"
                  ...
                  <?php
					...
					?>	
                  <option value="<?php echo $values["AreaName"];?>"><?php echo $values["AreaName"];?></option>
					<?php }?>
                </select>
				</div>
				<div class="form-group">
