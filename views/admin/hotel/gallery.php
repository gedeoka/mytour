...
<div class="clearfix"></div>
    <div class="box box-success">
			...
			<div class="row">
                        <?php
                        foreach ($this->HotGalList as $key => $value){
                        ?>
                        
                            <div class="imgList">
                                    <img src="<?php echo URL.$value['thumb']; ?>">
                                    <p><?php echo $value['Name']; ?></p>
                                    <a class="del btn btn-success" href="#" rel="<?php echo $value['GalleryID']; ?>" rels="<?php echo $value['HotelID']; ?>"> Delete </a>
                            </div>
...
$('.del').click(function(){
    ...
    $.post("<?php echo URL.'admin';?>/hoteldelgal",{gid:gid,prid:prid},function(x){
        //alert(x);
       delItem.remove();
    });
    return false;
