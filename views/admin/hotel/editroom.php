...
*/
	...
	<div class="box-body">
         <div class="row">
        <form role="form" action="<?php echo URL."admin/updateroom/".$this->singleRoom[0]["RoomID"];?>" method="POST">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
				  ...
				  <input name="HotelID" type="hidden" class="form-control" value="<?php echo $this->singleRoom[0]["HotelID"];?>">
              ...
              <div class="form-group">
				...
				<div class="form-group">
                  <label>Bed Type<br></label>
                  		<div class="form-group">
						  <?php
						  $x=explode(",",$this->singleRoom[0]["RoomType"]);
				foreach($this->roomtype as $key=>$value){ ?>
						<input type="checkbox" name="tp[]"
						<?php
				  if (in_array($value["TypeID"], $x)) {
						echo "Checked";
					}
				  ?>value="<?php echo $value["TypeID"];?>"
						class="flat-red"> &nbsp; &nbsp;<?php echo $value["TypeName"];?><br>
