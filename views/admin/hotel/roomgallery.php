			...
			<div class="row">
                        ...
                        ?>
                            ...
                            <div class="imgList">
                                    ...
                                    <a class="del btn btn-success" href="#" rel="<?php echo $value['GalleryID']; ?>" rels="<?php echo $value['RoomID']; ?>"> Delete </a>
                            </div>
...
$('.del').click(function(){
    ...
    $.post("<?php echo URL.'admin';?>/roomdelgal",{gid:gid,prid:prid},function(x){
        //alert(x);
       delItem.remove();
    });
    return false;
