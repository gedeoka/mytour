    ...
    <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title">Choose Package
			          <br><small><a href="<?php echo URL."admin/popular/";?>" class="btn btn-success btn-xs">Back</a></small></h3>
            </div>
            <div class="box-body">
              <!-- Minimal style -->
			<div class="row col-sm-12">
                        ...
                        ?>
                            ...
                            <div class="imgList">
                                    <h3><?php echo $value['TourName']; ?></h3>
                                    <div class="desk"><?php echo substr($value['Desk'],0,100); ?>
									<p>Price : <?php echo $value['Cur']." ".$value['Price1'];?></p></div>
                                    <a class="del btn btn-success" href="#" rel="<?php echo $value['TourID']; ?>" rels="<?php echo $value['TourID']; ?>"> Add To Promo </a>
                            </div>
...
$('.del').click(function(){
    ...
    $.post("<?php echo URL.'admin/';?>savepopular",{gid:gid,prid:prid},function(x){
       //alert(x);
       delItem.remove();
    });
    return false;
