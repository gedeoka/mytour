...
<div class="clearfix"></div>
    <div class="box box-success">
            <div class="box-header">
			  ...
			  <small> <a class="btn btn-success btn-xs" href="<?php echo URL;?>admin/addpopular/">Add New</a>  </small>
            </div>
            <div class="box-body">
              <!-- Minimal style -->
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
				  ...
				  <td>Price : <?php echo $value['Cur']." ".$value['Price1'];?></td>
                  <td><a class="del btn btn-success" href="#" rel="<?php echo $value['ID']; ?>" rels="<?php echo $value['ID']; ?>"> Remove Promo </a></td>
                </tr>
                <?php } ?>
                </tbody>
...
$('.del').click(function(){
    ...
    $.post("<?php echo URL.'admin/';?>delpopular",{gid:gid,prid:prid},function(x){
        //alert(x);
       //delItem.remove();
