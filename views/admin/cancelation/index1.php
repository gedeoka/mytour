        ...
        <div class="col-xs-12">
          ...
          <div class="box  col-xs-6">
            <div class="box-header with-border">
              <h3 class="box-title">Add New Cancelation</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo URL."admin/addcancelation";?>" method="GET">
              <div class="box-body  col-xs-6">
                <div class="form-group">
                  <label for="exampleInputEmail1">Cancelation Name :</label>
                  <input name="name" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Cancelation Level Name">
                </div>
		...
		<div class="clearfix"></div>
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Cancelation List  </h3><br>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
				<?php
                        foreach ($this->listcancelation as $key => $value) {
                            ?>
                <tr>
                  <td><?php echo $value['CancelID']; ?></td>
                  <td><?php echo $value['CancelName']; ?></td>
                  <td><a href="<?php echo URL;?>admin/cancelationedit/<?php echo $value['CancelID']; ?>"> Edit </a></td>
                </tr>
                <?php } ?>
                </tbody>
