        ...
        <div class="col-xs-12">
          ...
          <div class="box  col-xs-6">
            <div class="box-header with-border">
              <h3 class="box-title">Update Cancelation</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo URL."admin/updcancelation/".$this->cancelationSingle['CancelID'];?>" method="GET">
              <div class="box-body  col-xs-6">
                <div class="form-group">
                  <label for="exampleInputEmail1">Cancelation Name :</label>
                  <input name="name" type="text" class="form-control" id="exampleInputEmail1" value="<?php echo $this->cancelationSingle['CancelName']; ?>">
                </div>
