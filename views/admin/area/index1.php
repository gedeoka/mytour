      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box  col-xs-6">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo URL."admin/addarea";?>" method="POST" enctype="multipart/form-data" >
              <div class="box-body  col-xs-6">
                <div class="form-group">
                  <label for="exampleInputEmail1">Area Name :</label>
                  <input name="areaname" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Area Name">
                </div>
				<div class="form-group">
				...
				<div class="form-group">
                <label> Country :</label>
                <select name="country" class="form-control " data-placeholder="Select a Country" required
                        style="width: 100%;" >
                  <?php
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><a href="<?php echo URL;?>admin/areaedit/<?php echo $value['AreaID']; ?>"> Edit </a></td>
                </tr>
                <?php } ?>
                </tbody>
