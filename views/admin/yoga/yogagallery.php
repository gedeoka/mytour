			...
			<div class="row">
                        ...
                        ?>
                            ...
                            <div class="imgList">
                                    ...
                                    <a class="del btn btn-danger" href="#" rel="<?php echo $value['GalleryID']; ?>" rels="<?php echo $value['YogaID']; ?>"> Delete </a>
									<br>
									<?php 
									if ($value["Def"]==0){
										?>
										<a class="def btn btn-primary" href="#" rel="<?php echo $value['GalleryID']; ?>" rels="<?php echo $value['YogaID']; ?>"> Set Default </a>
										<?php
									}else{
										?>
										<a class="unset btn btn-success" href="#" rel="<?php echo $value['GalleryID']; ?>" rels="<?php echo $value['YogaID']; ?>"> Unset Default </a>
										<?php
									}
									?>
                            </div>
...
$('.del').click(function(){
    ...
    $.post("<?php echo URL.'admin/yoga';?>delgal",{gid:gid,prid:prid},function(x){
        //alert(x);
       delItem.remove();
    });
    return false;
...
//alert("def");
    ...
    $.post("<?php echo URL.'admin/yogadefg';?>",{gid:gid,prid:prid},function(x){
       location.reload();
    });
    //return false;
...
$('.unset').click(function(){
    ...
    $.post("<?php echo URL.'admin/yogaunsetg';?>",{gid:gid,prid:prid},function(x){
       location.reload();
    });
    // false;
