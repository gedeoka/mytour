        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">List All Yoga</b></h3><br>
			  <small> <a class="btn btn-success btn-xs" href="<?php echo URL;?>admin/addyoga/">Add New</a>  </small>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				<tbody>
				<?php
                        foreach ($this->listyoga as $key => $value) {
                            ?>
                <tr>
					<td><?php echo $value['YogaCode']; ?></td>
					<td><?php echo $value['YogaName']; ?></td>
				  ...
				  <td><?php echo $value['Cur']." ".number_format($value['Price1']); ?>/Person</td>
				  <td><a  class="btn btn-success btn-xs" href="<?php echo URL."admin/yogasetgallery/".$value['YogaID']; ?>"> Set<br>Gallery</a></td>
                  <td><a class="btn btn-warning btn-xs" href="<?php echo URL."admin/edityoga/".$value['YogaID']; ?>">Edit</a></td>
                  <td>
				  <div id="stat">
				  <?php if ($value['Status']==1){?>
				  <a class="btn btn-danger btn-xs del" rel="<?php echo $value['YogaID']; ?>"> Void</a>
				  <?php }else{?>
				  <a class="btn btn-danger btn-xs act" rel="<?php echo $value['YogaID']; ?>"> Activate</a>
				  <?php }?>
				  </div></td>
                </tr>
                <?php } ?>
