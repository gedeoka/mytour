...
?>
  ...
  <div class="content-wrapper">
	...
	<div class="box-body">
         <div class="row">
        <form role="form" action="<?php echo URL."admin/updateyoga";?>" method="POST">
        ...
        <div class="box-body">
          <div class="row">
			...
			<div class="form-group">
                  ...
                  <input name="YogaCode" type="text" class="form-control" placeholder="Enter Package Code" maxlength="200" value="<?php echo $this->singleyoga[0]["YogaCode"];?>" required>
				  
                </div>
              <div class="form-group">
                  <label>Package Name</label>
                  <input name="YogaName" type="text" class="form-control" placeholder="Enter Package Name" maxlength="50" value="<?php echo $this->singleyoga[0]["YogaName"];?>" required>
				  <input name="YogaID" type="hidden" class="form-control"  value="<?php echo $this->singleyoga[0]["YogaID"];?>" required>
                </div>
              ...
              <!-- /.form-group -->
                ...
                <select name="country" class="form-control " data-placeholder="Select a State"
                  ...
                  <?php
					...
					?>	
                  <option value="<?php echo $values["CountryID"];?>" <?php if ($this->singleyoga[0]["CountryID"]==$values["CountryID"]){ echo "Selected";}?>><?php echo $values["CountryName"];?></option>
					<?php }?>
                </select>
				</div>
              ...
              <div class="box-body pad">
					...
					<label>	Package Description				
						<textarea name="desk" class="textarea" placeholder="Package Descriptions."
                          style="width: 100%; height: 150px; font-size: 14px; font-weight:normal; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $this->singleyoga[0]["Desk"];?></textarea>
					</label>
              	 ...
              	 <div class="box-body pad">
					...
					<label>	Term and Condition : 	
						<textarea name="term" class="textarea" placeholder="Term And Condition."
                          style="width: 100%; height: 150px; font-size: 14px; font-weight:normal; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $this->singleyoga[0]["Term"];?></textarea>
					</label>
            ...
            <div class="col-md-6">
              ...
              <!-- Minimal style -->
                ...
                <div class="input-group date">
                  ...
                  <input type="text" name="StartDate" class="form-control pull-right" id="datepicker" value="<?php echo date("m/d/Y",strtotime($this->singleyoga[0]["StartDate"]));?>">
                </div>
                <!-- /.input group -->
              </div>
			  <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" name="EndDate" class="form-control pull-right" id="datepicker2" value="<?php echo date("m/d/Y",strtotime($this->singleyoga[0]["EndDate"]));?>">
                </div>
                <!-- /.input group -->
              </div>
			  <div class="form-group">
				 ...
				 <input name="Price1" id="Price1" type="number" class="form-control"  value="<?php echo $this->singleyoga[0]["Price1"];?>"
              ...
              <div class="box-body pad">
					...
					<label>	Inclusion : 	
						<textarea name="Inclusion" class="textarea" placeholder="Inclusion."
                          style="width: 100%; height: 150px; font-size: 14px; font-weight:normal; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $this->singleyoga[0]["Inclusion"];?></textarea>
					</label>
              ...
              <div class="box-body pad">
					...
					<label>				Exlusion:
						<textarea name="Exclusion" class="textarea" placeholder="Exclusion."
                          style="width: 100%; height: 150px; font-size: 14px; font-weight:normal; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $this->singleyoga[0]["Exclusion"];?></textarea>
					</label>
