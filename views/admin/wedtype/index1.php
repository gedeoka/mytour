        ...
        <div class="col-xs-12">
          ...
          <div class="box  col-xs-6">
            <div class="box-header with-border">
              <h3 class="box-title">Add New EO Type</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo URL."admin/addwedtype";?>" method="GET">
              <div class="box-body  col-xs-6">
                <div class="form-group">
                  <label for="exampleInputEmail1">EO Type Name :</label>
		...
		<div class="clearfix"></div>
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">EO Type List  </h3><br>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><a href="<?php echo URL;?>admin/wedtypeedit/<?php echo $value['ID']; ?>"> Edit </a></td>
                </tr>
                <?php } ?>
                </tbody>
