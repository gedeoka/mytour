...
?>
  ...
  <div class="content-wrapper">
	...
	<div class="box-body">
         <div class="row">
        <form role="form" action="<?php echo URL."admin/updtiket";?>" method="POST">
            ...
            <div class="col-md-12">
              ...
              <div class="form-group">
					...
					<label>				Page Detail:</label>
						...
						<textarea name="desk" id="desk" class="textarea" placeholder="Exclusion."
...
<!-- CK Editor -->
<script src="<?php echo URL;?>include/plugin/ckeditor/ckeditor.js"></script>
</body>
</html>
<script>
  $(function () {
